...
$_['text_subscription_trial']    = '%s a cada %d %s(s) durante %d pagamento(s) e depois ';
$_['text_subscription_duration'] = '%s a cada %d %s(s) durante %d pagamento(s)';
$_['text_subscription_cancel']   = '%s a cada %d %s(s) até cancelamento';
$_['text_cancel']                = 'Até o Cancelamento';
$_['text_day']                   = 'Dia';
$_['text_week']                  = 'Semana';
...
$_['text_history_add']           = 'Adicionar ao Histórico';
$_['text_log']                   = 'Logs';
